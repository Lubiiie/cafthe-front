        ...
        <header style={styles.header}>
            <div style={styles.container}>
                <div style={styles.sectionSide}>
                    <Link to="/">
                        {/* SEO : Alt optimisé */}
                        <img src="/logo1.webp" alt="CafThé - Torréfacteur de cafés et thés d'exception" style={styles.logo} />
                    </Link>
                </div>

                {/* AJOUT DE LA BALISE NAV POUR LE PROFESSEUR */}
...
const styles = {
    ...
    // navWrapper assure que la navigation occupe le reste de l'espace
    ...
    searchInput: { width: "100%", padding: "12px 45px 12px 20px", borderRadius: "30px", border: "none", backgroundColor: "#E9E3E3", fontSize: "1rem", outline: "none", color: "#373735" },
    ...
    badge: { position: "absolute", top: "-8px", right: "-10px", backgroundColor: "#C9A24D", color: "#373735", fontSize: "12px", fontWeight: "bold", borderRadius: "50%", width: "20px", height: "20px", display: "flex", justifyContent: "center", alignItems: "center", border: "1.5px solid #373735" },
    ...
    welcomeText: { color: "#C9A24D", fontSize: "1.05rem", fontWeight: "bold" },
